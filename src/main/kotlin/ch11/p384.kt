...
typealias DoubleConversion2 = (Double) -> Double
...
fun getConversionLambda2(str: String): DoubleConversion {
...
fun main() {
    println("Convert 2.5kg to Pounds: ${getConversionLambda2("KgsToPounds")(2.5)}")

    val kgsToPoundsLambda = getConversionLambda2("KgsToPounds")
